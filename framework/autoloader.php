    ...
    class AutoLoader {
        ...
        */
        public function checkAndRequire($filename,$classname) {
            if(!is_readable($filename)) throw new AutoloaderError('Fichier inexistant '.$filename,$classname);            
         ...
         */
        private function oldLoader($className) { 
        ...
        private function loader($className) 
        {
            ...
            switch($parts[0])
            {
                ...
                case $this->frameworkNamespace:
                    ...
                    break;
                default:
                    throw new AutoloaderError("Package inconnu ".$className);
            }             
